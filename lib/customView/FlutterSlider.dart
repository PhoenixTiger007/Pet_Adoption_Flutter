...
class _FlutterSliderState extends State<FlutterSlider>
  ...
  double _handlersWidth=0;
  double _handlersHeight=0;

  double _constraintMaxWidth=0;
  double _constraintMaxHeight=0;

  double _containerWidthWithoutPadding=0;
  double _containerHeightWithoutPadding=0;
  ...
  double __dAxis=0,
      ...
      __axisDragTmp=0,
      __axisPosTmp=0,
      __containerSizeWithoutPadding=0,
      __rightHandlerPosition=0,
      __leftHandlerPosition=0,
      __containerSizeWithoutHalfPadding=0;

  Orientation? oldOrientation;

  double __lockedHandlersDragOffset = 0;
  double _distanceFromRightHandler=0, _distanceFromLeftHandler=0;
...
//                  ..._points,
  ...
  void _drawHatchMark() {
    ...
    hatchMark.displayLines = widget.hatchMark!.displayLines ;


    if (hatchMark.displayLines!) {
      double percent = 100 * hatchMark.density;
      double barWidth, barHeight, distance;
      double linesTop, linesLeft, linesRight=0, linesBottom=0;
...
//        left = (p * distance) + _handlersPadding - labelBoxHalfSize - 0.5;
    ...
    if (hatchMark.labels != null && hatchMark.labels!.isNotEmpty) {
      ...
      double top, left, bottom=0, right=0;
      double tr;
...
//    items      ..addAll(_points);
  ...
  Positioned _tooltip(
      {String? side, dynamic value, double? opacity, Animation<Offset>? animation}) {
